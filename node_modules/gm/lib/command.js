...
module.exports = function (proto) {
   ...
   *
   * `formatters` are passed an array of img which will be
   * used as 'input' img for the command. Useful for methods
   * like `.append()` where multiple source img may be used.
   *
